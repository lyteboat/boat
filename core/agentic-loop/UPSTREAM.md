...
Forked from deepseek-ai/deepseek-harness at dsh-v0.1.5-alpha.2 (b2e3b2a0125854567a4a5fcba75782e42fe84901), MIT:
...
- `PreparedStep` gains the `reply` member; imports from `@boat/contracts` and `@deepseek-ai/dsh-llm` (`createAssistantMessage`, `createSystemMessage`).

`src/runtime-context.ts`

- Exports `SYSTEM_PROMPT_SOURCE` (the system-prompt seam's plugin name) for `replyStep`.
