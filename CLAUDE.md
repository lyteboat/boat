...
- **Fixtures**: agent presets under `apps/cli/tests/fixtures/agents/<id>`, templates under `plugins/a2ui/tests/fixtures`, ark baselines under `tests/fixtures/baseline`. Fix the fixture, never the normalizer.
