...
lyteboat/
  ...
  agents/finance/         @lyteboat/agent-finance — an agent directory, kept minimal (public knowledge only): agent.cordis.yml, preset.yml, assets/ (skills/: three routed, a2ui/: four cards, sample-data/), src/ → lib/ (three tools, an admission ahead of the loop); the request context names the customer
