...
lyteboat/
  ...
  tooling/testing/        @lyteboat/testing — the test harness lyteboat's packages use: createLyteboatUnitHost + MockAdapter, composition, scratch, scripted-model, session-log, session-reopen, chat-client, json-lines, process
