...
export class SessionManager {
    ...
    resolveTarget(target) {
        ...
        this.sessions.get(id)?.configureSubagent(address, address === undefined
            ? undefined
        ...
        this.listInflight = (async () => {
            try {
                ...
                if (result.ok) {
                    ...
                    const removedSincePull = new Set();
