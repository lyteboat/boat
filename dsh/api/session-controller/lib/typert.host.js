...
const _deepseek_ai_dsh_api_session_controller_session_control_result$schema = () => (_deepseek_ai_dsh_api_session_controller_session_control_result$schema$value ??= z.union([z.object({
  ...
  'content': z.string(),
  'status': z.union([z.literal("completed"), z.literal("pending"), z.literal("in_progress")]),
}))]).optional(),
  ...
  'mode': z.literal("unknown").readonly(),
  'label': z.string().readonly().optional(),
}))])).optional(),
...
const _deepseek_ai_dsh_api_session_controller_session_follow_parameter_0$schema = () => (_deepseek_ai_dsh_api_session_controller_session_follow_parameter_0$schema$value ??= z.object({
  ...
  'mode': z.union([z.literal("one-shot"), z.literal("continuable"), z.literal("unknown")]).readonly(),
})]).readonly(),
  'assistantStream': z.literal(true).readonly().optional(),
  'maxMessages': z.number().readonly().optional(),
  'turnWindow': z.object({
  'minMessages': z.number().readonly(),
  'minTurns': z.number().readonly(),
}).readonly().optional(),
}))
...
const _deepseek_ai_dsh_api_session_controller_session_initializeDefaultModel_result$schema = () => (_deepseek_ai_dsh_api_session_controller_session_initializeDefaultModel_result$schema$value ??= z.void())
...
const _deepseek_ai_dsh_api_session_controller_session_list_result$schema = () => (_deepseek_ai_dsh_api_session_controller_session_list_result$schema$value ??= z.object({
  ...
  'agentAvailable': z.boolean().readonly(),
  'sessionId': z.intersection(z.string(), z.unknown()).readonly(),
  'updatedAt': z.number().readonly(),
  ...
  'cwd': z.string().readonly().optional(),
  'projections': z.object({
  'kind': z.union([z.literal("cached"), z.literal("sequenced")]).readonly(),
  'asOfSeq': z.number().readonly(),
  'values': z.intersection(z.object({
  'inbox': z.object({
...
const _deepseek_ai_dsh_api_session_controller_session_openWorkspacePath_parameter_0$schema = () => (_deepseek_ai_dsh_api_session_controller_session_openWorkspacePath_parameter_0$schema$value ??= z.object({
  ...
  'application': z.string().readonly().optional(),
...
const _deepseek_ai_dsh_api_session_controller_session_projections_parameter_0$schema = () => (_deepseek_ai_dsh_api_session_controller_session_projections_parameter_0$schema$value ??= z.object({
  'sessionId': z.intersection(z.string(), z.unknown()).readonly(),
}))
let _deepseek_ai_dsh_api_session_controller_session_projections_result$schema$value
const _deepseek_ai_dsh_api_session_controller_session_projections_result$schema = () => (_deepseek_ai_dsh_api_session_controller_session_projections_result$schema$value ??= z.union([z.literal(null), z.object({
  'asOfSeq': z.number().readonly(),
  'values': z.intersection(z.object({
  'inbox': z.object({
...
const _deepseek_ai_dsh_api_session_controller_session_workspacePathApplications_parameter_0$schema = () => (_deepseek_ai_dsh_api_session_controller_session_workspacePathApplications_parameter_0$schema$value ??= z.object({
  'path': z.string().readonly(),
}))
let _deepseek_ai_dsh_api_session_controller_session_workspacePathApplications_result$schema$value
const _deepseek_ai_dsh_api_session_controller_session_workspacePathApplications_result$schema = () => (_deepseek_ai_dsh_api_session_controller_session_workspacePathApplications_result$schema$value ??= z.array(z.object({
  'id': z.string().readonly(),
  'name': z.string().readonly(),
  'default': z.boolean().readonly(),
  'icon': z.union([z.literal(null), z.string()]).readonly(),
})))
...
export const TYPERT = {
  ...
  invocations: [
    ...
    },
    {
      ...
      sourceLocation: {"file":"packages/api/session-controller/src/index.ts","line":437,"column":3},
    },
    {
    ...
    },
    {
      ...
      sourceLocation: {"file":"packages/api/session-controller/src/index.ts","line":319,"column":3},
    },
    {
      ...
      sourceLocation: {"file":"packages/api/session-controller/src/index.ts","line":520,"column":3},
    },
    {
    ...
    },
    {
      ...
      sourceLocation: {"file":"packages/api/session-controller/src/index.ts","line":480,"column":3},
    },
    {
      ...
      sourceLocation: {"file":"packages/api/session-controller/src/index.ts","line":415,"column":3},
    },
    {
      ...
      sourceLocation: {"file":"packages/api/session-controller/src/index.ts","line":292,"column":9},
    },
    {
      ...
      sourceLocation: {"file":"packages/api/session-controller/src/index.ts","line":252,"column":9},
    },
    {
    ...
    },
    {
      ...
      sourceLocation: {"file":"packages/api/session-controller/src/index.ts","line":340,"column":9},
    },
    {
      ...
      sourceLocation: {"file":"packages/api/session-controller/src/index.ts","line":468,"column":3},
    },
    {
      ...
      sourceLocation: {"file":"packages/api/session-controller/src/index.ts","line":491,"column":9},
    },
    {
      ...
      sourceLocation: {"file":"packages/api/session-controller/src/index.ts","line":426,"column":3},
    },
    {
      ...
      sourceLocation: {"file":"packages/api/session-controller/src/index.ts","line":403,"column":3},
    },
    {
    ...
    },
    {
      ...
      sourceLocation: {"file":"packages/api/session-controller/src/index.ts","line":283,"column":3},
    },
    {
      ...
      sourceLocation: {"file":"packages/api/session-controller/src/index.ts","line":447,"column":3},
    },
    {
      ...
      sourceLocation: {"file":"packages/api/session-controller/src/index.ts","line":370,"column":9},
    },
    {
      ...
      sourceLocation: {"file":"packages/api/session-controller/src/skill-catalog.ts","line":35,"column":9},
    },
  ],
  model: {
    "services": [
      {
        ...
        "members": [
          ...
          },
          {
            ...
            "summary": "Select one Session-local model after explicitly resuming the Session; save the default in the background.",
          ...
          },
          {
            ...
            "summary": "Select the first available account model after login when no provider API key is configured.",
          ...
          },
          {
            ...
            "summary": "Verify one path through the composed filesystem and open it on the Host desktop.",
          ...
          },
          {
            ...
            "summary": "Query current file handlers on the serving desktop without activating an Agent.",
          ...
          },
          {
            ...
            "summary": "Fork one cold-readable exact event prefix into a new Session.",
          ...
          },
          {
            ...
            "summary": "Mutate one still-pending queue occurrence, resuming a cold Agent first.",
        ...
        "types": [
          ...
          {
            "name": "LegacyAfterScheduleRecord",
            "declaration": "export interface LegacyAfterScheduleRecord extends Omit<AfterScheduleRecord, 'title'> {\n    readonly title?: string;\n}"
          },
          {
            "name": "LegacyAtScheduleRecord",
            "declaration": "export interface LegacyAtScheduleRecord extends Omit<AtScheduleRecord, 'title'> {\n    readonly title?: string;\n}"
          },
          {
            "name": "LegacyEveryScheduleRecord",
            "declaration": "export interface LegacyEveryScheduleRecord extends Omit<EveryScheduleRecord, 'title'> {\n    readonly title?: string;\n}"
          },
          {
            "name": "LegacyScheduleRecord",
            "declaration": "export type LegacyScheduleRecord = LegacyAfterScheduleRecord | LegacyAtScheduleRecord | LegacyEveryScheduleRecord;"
          },
          {
            "name": "LlmAttemptId",
          ...
          {
            "name": "OfficeToPdfErrorCode",
            "declaration": "export type OfficeToPdfErrorCode = 'input-too-large' | 'output-too-large' | 'invalid-document' | 'unsupported-format' | 'invalid-output' | 'timeout' | 'unavailable' | 'failed' | 'busy' | 'source-changed';"
          },
          {
          ...
          {
            "name": "QueueAction",
            "declaration": "export type QueueAction = { readonly kind: 'edit'; readonly content: readonly TextBlock[]; } | { readonly kind: 'remove'; } | { readonly kind: 'steer'; };"
          },
          {
            "name": "ReasoningBlock",
          ...
          {
            "name": "ScheduleChange",
            "declaration": "export type ScheduleChange = ScheduleCreateChange | ScheduleDeleteChange | ScheduleDispatchChange;"
          },
          {
          ...
          {
            "name": "SessionAddress",
            "declaration": "export type SessionAddress = { readonly kind: 'session'; readonly sessionId: SessionId; } | { readonly kind: 'subagent'; readonly parentSessionId: SessionId; readonly childSessionId: SessionId; readonly mode: 'one-shot' | 'continuable' | 'unknown'; };"
          },
          {
          ...
          },
          {
            ...
            "declaration": "export type SessionControlFrame = { readonly type: 'baseline'; readonly value: SessionControlBaseline; } | ({ readonly type: 'projection'; } & SessionProjectionUpdate);"
          },
          {
      ...
      },
      {
        ...
        "tags": [
          ...
          },
          {
            "name": "param",
            "argument": "summary",
            "comment": "- current list row for the Session.",
            "text": "@param summary - current list row for the Session."
          }
        ],
